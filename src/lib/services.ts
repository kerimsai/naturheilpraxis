...
export const services: Service[] = [
  {
    ...
    longDescription: `<h3 class="font-bold text-2xl pt-4 font-headline">Was ist Vitamin C?</h3><p>Vitamin C ist ein wasserlösliches Vitamin. Der Mensch kann Vitamin C nicht selbst herstellen sondern muss es über die Ernährung aufnehmen. Eine gesunde Ernährung muss also genügend Vitamin C enthalten. Bei Krankheit oder vermehrter Stressbelastung steigt der Bedarf an Vitamin C an.</p><p>Vitamin C kann nicht vom Körper gespeichert werden. Auch der Darm kann nur eine begrenzte Menge an Vitamin C aufnehmen (ca. 200mg). Deshalb können orale Einnahmen keine hohen Vitamin-C-Spiegel erreichen.</p><h3 class="font-bold text-2xl pt-4 font-headline">Vitamin C ist an vielen Prozessen im Körper beteiligt:</h3><ul class="list-disc list-inside space-y-2 mt-2"><li>Schützt Gewebe vor oxidativen Stress</li><li>Unterstützt das Immunsystem und kardiovaskuläre System</li><li>Entgiftende Abläufe in der Leber</li><li>Wundheilung und Knochenstoffwechsel</li><li>Energiestoffwechsel</li><li>Eisenstoffwechsel</li></ul><h3 class="font-bold text-2xl pt-4 font-headline">Wofür kann eine Vitamin-C-Infusion eingesetzt werden?</h3><ul class="list-disc list-inside space-y-2 mt-2"><li>Vitamin-C-Mangelzustände</li><li>Erhöhter Verbrauch von Vitamin C durch:</li></ul><ul class="list-disc list-inside space-y-2 mt-2 ml-6"><li>Stressbelastung (Long-Covid)</li><li>Entzündliche Erkrankungen</li><li>Allergien</li><li>chronische Darmerkrankungen</li><li>Blasenentzündungen</li><li>Infektanfälligkeit</li><li>Wundheilungsstörungen</li><li>Unterstützt die Eisenaufnahme</li><li>Erhöhte Leberwerte / Fettleber</li></ul><h3 class="font-bold text-2xl pt-4 font-headline">Wie häufig sollte eine Vitamin-C-Infusion durchgeführt werden?</h3><p>Die Vitamin-C-Infusion sollte 4-6x im Abstand von 1-3x pro Woche durchgeführt werden.</p><p>Eine Vitamin-C-Infusion lässt sich sehr gut mit kosmetischen Behandlungen kombinieren oder mit homöopathischen Mitteln erweitern. Lassen Sie sich von mir beraten!</p>`,
  ...
  },
  {
    ...
    longDescription: `<p>Das Besondere an der Manuellen-Neuro-Therapie nach Walter Froneberg ist die Kombination aus drei Einzeltechniken:</p><ol class="list-decimal list-inside space-y-2 mt-2"><li>Die Behandlung beginnt mit einer spezifischen Muskel- und Nervenmassage.</li><li>Darauf folgt eine Nervenreflextherapie am Fuß. Mit ihr ist es möglich, direkt am und über das Nervensystem den Körper in allen Ebenen zu erfassen.</li><li>Dann erfolgt eine modifizierte Gelenkmobilisation.</li></ol><p>Durch diese bestmöglich aufeinander abgestimmten Einzeltechniken ist ein schneller Zugriff auf Muskel, Bänder, Gelenke, Nerven und Organe weitgehend möglich.</p><p>Die Manuelle Neurotherapie kann vielfache Beschwerden erfassen und schließt somit eine ganzheitliche Betrachtung des Menschen mit ein.</p><h3 class="font-bold text-2xl pt-4 font-headline">Einige Beispiele für Krankheitsbilder:</h3><ul class="list-disc list-inside space-y-2 mt-2"><li>Hexenschuss</li><li>Ischialgie</li><li>Kopfschmerzen</li><li>Magen-Darmprobleme</li><li>Verstopfung (auch nach Schwangerschaft)</li><li>Rückenschmerzen</li><li>uvm.</li></ul>`,
    price: "Individuell nach Anamnese",
    image: "https://placehold.co/800x600.png",
