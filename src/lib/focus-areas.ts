...
export const focusAreas: FocusArea[] = [
    {
        ...
        longDescription: "Akne wird oft durch hormonelle Schwankungen, Ernährung und Stress beeinflusst. Ich verfolge einen ganzheitlichen Ansatz, der die Ursachen erforscht und durch natürliche Heilmethoden wie Kräutertherapie, Ernährungsberatung und Mikronährstofftherapie die Hautgesundheit von innen heraus verbessert."
    },
    {
        ...
        longDescription: "Bei Allergien und Autoimmunerkrankungen ist das Immunsystem fehlgeleitet. Mein Ziel ist es, das Immunsystem zu modulieren und zu beruhigen. Durch Darmsanierung, Ausleitungsverfahren und gezielte Nährstofftherapie unterstütze ich den Körper dabei, wieder ins Gleichgewicht zu finden und Überreaktionen zu reduzieren."
    },
    {
        slug: "juckreiz",
        icon: Waves,
    ...
    },
    {
        ...
        longDescription: "Neurodermitis (atopisches Ekzem) ist eine chronisch-entzündliche Hauterkrankung, die eng mit dem Darm und dem Immunsystem verbunden ist. Mein Behandlungsansatz umfasst eine detaillierte Mikrobiom-Analyse, eine entzündungshemmende Ernährungsstrategie und den Einsatz von Pflanzenheilkunde, um die Hautbarriere zu stärken und Schübe zu minimieren."
    },
    {
        ...
        longDescription: "Schuppenflechte (Psoriasis) ist eine Autoimmunerkrankung, die sich auf der Haut manifestiert. Ich konzentriere mich auf die Beruhigung des Immunsystems und die Reduzierung von Entzündungen im Körper. Entgiftungsverfahren, spezielle Diäten und naturheilkundliche Mittel sind zentrale Bestandteile meiner Therapie, um die Symptome zu kontrollieren und das Hautbild zu verbessern."
    },
    {
        slug: "warzen",
        icon: Shield,
